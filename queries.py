...
the code containes useful queries and it offers an example on how to execute
a quary and to get the output in a pandas DataFrame. It also shows an example
on how to save (export as excel file) the results and to plot some output data.
...
INNER JOIN postsynaptic_potentals
ON postsynaptic_currents_and_firing.date_of_recording =
postsynaptic_potentals.date_of_recording AND
postsynaptic_currents_and_firing.neuron_number =
postsynaptic_potentals.neuron_number
